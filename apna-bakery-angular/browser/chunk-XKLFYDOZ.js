...
// src/app/common/productdetails/productdetails.component.ts
function ProductdetailsComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11, " This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "p", 8)(13, "small", 9);
    \u0275\u0275text(14, "Last purchased 3 mins ago");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "mat-form-field")(16, "mat-label");
    \u0275\u0275text(17, "Select quantity");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "mat-select", 10);
    \u0275\u0275twoWayListener("valueChange", function ProductdetailsComponent_Conditional_1_Template_mat_select_valueChange_18_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(24, "3");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div")(26, "button", 14);
    \u0275\u0275listener("click", function ProductdetailsComponent_Conditional_1_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ProductdetailsComponent_Conditional_1_Template_button_click_30_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sendback());
    });
    \u0275\u0275element(31, "i", 15);
    \u0275\u0275text(32, " Back ");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.product.item.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("width", 250, "px")("margin", 2, "px");
    \u0275\u0275property("src", ctx_r1.product.item.src, \u0275\u0275sanitizeUrl)("title", ctx_r1.product.item.name);
    \u0275\u0275advance(13);
    \u0275\u0275twoWayProperty("value", ctx_r1.selected);
  }
}
var _ProductdetailsComponent = class _ProductdetailsComponent {
  constructor(router, location, cart) {
    this.router = router;
...
_ProductdetailsComponent.\u0275fac = function ProductdetailsComponent_Factory(t) {
  return new (t || _ProductdetailsComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(Location), \u0275\u0275directiveInject(CartService));
};
_ProductdetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductdetailsComponent, selectors: [["app-productdetails"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 1, consts: [[1, "container"], [1, "card", "mb-3", "mt-5", 2, "max-width", "80%", "border", "0px"], [1, "row", "g-0"], [1, "col-md-4"], [1, "center-block", "img-responsive", "img-fluid", "rounded-start", 3, "src", "title"], [1, "col-md-8"], [1, "card-body"], [1, "card-title"], [1, "card-text"], [1, "text-muted"], [3, "valueChange", "value"], ["value", "1"], ["value", "2"], ["value", "3"], [1, "btn", "btn-primary", 2, "width", "auto", 3, "click"], [1, "fa", "fa-chevron-left"], [1, "card-footer"], [1, "btn", "btn-outline-secondary", 2, "width", "80px", 3, "click"]], template: function ProductdetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275template(1, ProductdetailsComponent_Conditional_1_Template, 33, 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275conditional(1, ctx.product ? 1 : -1);
  }
}, dependencies: [MatFormFieldModule, MatFormField, MatLabel, MatSelectModule, MatSelect, MatOption] });
var ProductdetailsComponent = _ProductdetailsComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductdetailsComponent, { className: "ProductdetailsComponent", filePath: "src\\app\\common\\productdetails\\productdetails.component.ts", lineNumber: 18 });
})();
export {
  ProductdetailsComponent
};
//# sourceMappingURL=chunk-XKLFYDOZ.js.map
